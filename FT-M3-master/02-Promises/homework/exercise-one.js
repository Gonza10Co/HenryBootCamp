...
function problemA() {
  ...
  // promise version
  promisifiedReadFile(`poem-one/stanza-01.txt`).then((text) => blue(text));
}
...
function problemB() {
  ...
  // promise version
  promisifiedReadFile(`poem-one/stanza-02.txt`).then((text) => blue(text));
  promisifiedReadFile(`poem-one/stanza-03.txt`).then((text) => blue(text));
}
...
function problemC() {
  ...
  // Asi funciona pero no es a idea, anidar y anidar...
  // promisifiedReadFile(`poem-one/stanza-02.txt`).then((text) => {
  //   blue(text);
  //   promisifiedReadFile(`poem-one/stanza-03.txt`).then(text => {
  //     blue(text);
  //     console.log('done')
  //   })
  // });
